...
void main()
{
    ...
    for (row = 0; row < height; row++)
    {
...

        {
            ...
            else if (col == row && !(row >= 4))
            {
                printf("*");
            }

            else if (col == (height - row) - 2 && !(row >= 4))
            {
                printf("*");
            }
            else
    ...
    for (row = 0; row < height; row++)
    {
...

        {
            ...
            else if ((col == 3) && (row == height - 1))
            {
                printf("*");
            }

            else if ((col == 2 || col == width - 2) && (row == height - 3))
            {
                printf("*");
            }
            else
